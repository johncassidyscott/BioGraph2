...
def ingest_edgar_exhibits():
    ...
    try:
        ...
        cur = conn.cursor()
        print("Running SELECT id, accession, issuer_id FROM filing WHERE filed_at >= '2025-01-01';")
        cur.execute("SELECT id, accession, issuer_id FROM filing WHERE filed_at >= '2025-01-01';")
